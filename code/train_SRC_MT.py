...
parser.add_argument('--root_path', type=str, default='D:/Dataset_01/skin', help='dataset root dir')
parser.add_argument('--csv_file_train', type=str, default="C:/Users/30812/Desktop/Test code of skin/SRC-MT-master/data/skin/training.csv", help='training set csv file')
...
parser.add_argument('--csv_file_test', type=str, default='C:/Users/30812/Desktop/Test code of skin/SRC-MT-master/data/skin/testing.csv', help='testing set csv file')
...
parser.add_argument('--num_classes', type=float,  default=7, help='num_classes')
...
if __name__ == "__main__":
    ...
    unlabeled_idxs = list(range(args.labeled_num, 7012))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i, (_,_, (image_batch, ema_image_batch), label_batch) in enumerate(train_dataloader):
            ...
            if i % 100 == 0:
                ...
                logging.info("\nEpoch: {}, iteration: {}/{}, ==> train <===, loss: {:.6f}, classification loss: {:.6f}, consistency loss: {:.6f}, consistency relation loss: {:.6f}, consistency weight: {:.6f},threshold: {:.6f}, lr: {}"
                            .format(epoch, i, iter_max, meters_loss.loss.avg, meters_loss_classification.loss.avg, meters_loss_consistency.loss.avg, meters_loss_consistency_relation.loss.avg, consistency_weight, threshold, optimizer.param_groups[0]['lr']))
